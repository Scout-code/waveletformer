...
train_loader = DataLoader(train_dataset, batch_size=BATCH_SIZE*1, shuffle=True)    #shuffle 是否打乱加载数据
test_loader = DataLoader(test_dataset, batch_size=BATCH_SIZE*20, shuffle=False)
...
def convoformer_v1_small(in_channel, out_channel):
